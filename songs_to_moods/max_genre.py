...
tone = {'Anger':0, 'Disgust':1, 'Fear':2, 'Joy':3, 'Sadness':4}
basepath = './'
...
for fname in os.listdir(basepath):
    ...
    if not os.path.isdir(path):
        ...
        if ext == 'json':
            ...
            tone_index = tone.get(entire_tone_word)
            ...
            outfile = open('./' + entire_tone_word + '/' + filename + '.txt', 'w')
            ...
            # Write out the sentence, the given tone word, and the max tone word
